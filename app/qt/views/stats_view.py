...
class QtStatsView(QWidget):
    ...
    def _setup_general_tab(self) -> None:
        ...
        self._gen_table.setStyleSheet(
            f"QTableWidget {{ background: {theme_manager.get_color('surface')}; border: 1px solid {theme_manager.get_color('border')}; border-radius: 8px; }}"
    ...
    def _on_theme_changed(self) -> None:
        ...
        self._gen_table.setStyleSheet(
            f"QTableWidget {{ background: {c['surface']}; border: 1px solid {c['border']}; border-radius: 8px; }}"
